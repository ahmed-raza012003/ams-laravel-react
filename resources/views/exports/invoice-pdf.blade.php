    ...
    <div class="container">
        <div class="header">
            ...
            <div class="invoice-info">
                ...
                <div class="invoice-details">
                    ...
                    <p><strong>Issue Date:</strong> {{ \App\Services\ExportService::formatDate($invoice->issue_date) }}</p>
                    <p><strong>Due Date:</strong> {{ \App\Services\ExportService::formatDate($invoice->due_date) }}</p>
        ...
        <div class="totals-section">
            <div class="totals-box">
                <div class="total-row">
                    <span>Subtotal:</span>
                    <span>{{ \App\Services\ExportService::formatCurrency($invoice->subtotal ?? 0, $currency) }}</span>
                </div>
                <div class="total-row">
                    <span>Tax Amount:</span>
                    <span>{{ \App\Services\ExportService::formatCurrency($invoice->tax_amount ?? 0, $currency) }}</span>
                </div>
                <div class="total-row total-final">
                    <span>Total:</span>
                    <span>{{ \App\Services\ExportService::formatCurrency($invoice->total ?? 0, $currency) }}</span>
                </div>
            </div>
        </div>
