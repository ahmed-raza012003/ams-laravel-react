...
export default function Index({ categories }) {
    ...
    const handleCreate = (e) => {
        e.preventDefault();
        createForm.post('/customer/sales-categories', {
            onSuccess: () => {
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        editForm.put(`/customer/sales-categories/${selectedCategory.id}`, {
            onSuccess: () => {
    ...
    const confirmDelete = () => {
        router.delete(`/customer/sales-categories/${selectedCategory.id}`, {
            onSuccess: () => {
    ...
    return (
        <CustomerLayout title="Sales Categories">
