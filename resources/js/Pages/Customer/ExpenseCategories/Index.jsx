...
export default function Index({ categories }) {
    ...
    const handleCreate = (e) => {
        e.preventDefault();
        createForm.post('/customer/expense-categories', {
            onSuccess: () => {
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        editForm.put(`/customer/expense-categories/${selectedCategory.id}`, {
            onSuccess: () => {
    ...
    const confirmDelete = () => {
        router.delete(`/customer/expense-categories/${selectedCategory.id}`, {
            onSuccess: () => {
    ...
    return (
        <CustomerLayout title="Expense Categories">
            ...
            <Modal show={showCreateModal} onClose={() => setShowCreateModal(false)} title="Add Expense Category" maxWidth="md">
            ...
            <Modal show={showEditModal} onClose={() => setShowEditModal(false)} title="Edit Expense Category" maxWidth="md">
