...
export default function Index({ items, categories, taxTypes, currency }) {
    ...
    const handleCreate = (e) => {
        e.preventDefault();
        createForm.post('/customer/items', {
            onSuccess: () => {
    ...
    const handleEdit = async (item) => {
        const response = await fetch(`/customer/items/${item.id}`);
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        editForm.put(`/customer/items/${selectedItem.id}`, {
            onSuccess: () => {
    ...
    const confirmDelete = () => {
        router.delete(`/customer/items/${selectedItem.id}`, {
            onSuccess: () => {
    ...
    const confirmStockUpdate = (e) => {
        e.preventDefault();
        stockForm.put(`/customer/items/${selectedItem.id}/stock`, {
            onSuccess: () => {
