...
export default function Index({ items, currency }) {
    ...
    const handleCreate = (e) => {
        e.preventDefault();
        createForm.post('/customer/items', { onSuccess: () => { setShowCreateModal(false); createForm.reset(); } });
    };
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        editForm.put(`/customer/items/${selectedItem.id}`, { onSuccess: () => { setShowEditModal(false); setSelectedItem(null); } });
    };
    ...
    const confirmDelete = () => { router.delete(`/customer/items/${selectedItem.id}`, { onSuccess: () => { setShowDeleteModal(false); setSelectedItem(null); } }); };
    ...
    return (
        <CustomerLayout title="Items">
            <Head title="Items" />
            <div className="mb-6 flex justify-between items-center">
                <p className="text-gray-600">Manage your products and services</p>
                <div className="flex items-center space-x-3">
                    <ExportButton 
                        pdfUrl="/customer/items/export/pdf"
                        excelUrl="/customer/items/export/excel"
                    />
