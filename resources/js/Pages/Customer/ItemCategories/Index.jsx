...
export default function Index({ categories }) {
    ...
    const handleCreate = (e) => {
        e.preventDefault();
        createForm.post('/customer/item-categories', {
            onSuccess: () => {
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        editForm.put(`/customer/item-categories/${selectedCategory.id}`, {
            onSuccess: () => {
    ...
    const confirmDelete = () => {
        router.delete(`/customer/item-categories/${selectedCategory.id}`, {
            onSuccess: () => {
    ...
    return (
        <CustomerLayout title="Item Categories">
            ...
            <Modal show={showCreateModal} onClose={() => setShowCreateModal(false)} title="Add Item Category" maxWidth="md">
            ...
            <Modal show={showEditModal} onClose={() => setShowEditModal(false)} title="Edit Item Category" maxWidth="md">
