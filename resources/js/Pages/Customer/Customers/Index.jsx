...
export default function Index({ customers }) {
    ...
    const handleCreate = (e) => {
        e.preventDefault();
        createForm.post('/customer/customers', {
            onSuccess: () => {
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        editForm.put(`/customer/customers/${selectedCustomer.id}`, {
            onSuccess: () => {
    ...
    const confirmDelete = () => {
        router.delete(`/customer/customers/${selectedCustomer.id}`, {
            onSuccess: () => {
        ...
        <CustomerLayout title="Customers">
            ...
            <div className="mb-6 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-3">
                    <ExportButton 
                        pdfUrl="/customer/customers/export/pdf"
                        excelUrl="/customer/customers/export/excel"
                    />
