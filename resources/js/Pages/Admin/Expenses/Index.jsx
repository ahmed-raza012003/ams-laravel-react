...
export default function Index({ expenses, customers, categories, currency }) {
    ...
    const handleCreate = (e) => {
        e.preventDefault();
        createForm.post('/admin/expenses', { onSuccess: () => { setShowCreateModal(false); createForm.reset(); } });
    };
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        editForm.put(`/admin/expenses/${selectedExpense.id}`, { onSuccess: () => { setShowEditModal(false); setSelectedExpense(null); } });
    };
    ...
    const confirmDelete = () => { router.delete(`/admin/expenses/${selectedExpense.id}`, { onSuccess: () => { setShowDeleteModal(false); setSelectedExpense(null); } }); };
