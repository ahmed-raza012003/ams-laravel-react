...
export default function Index({ taxTypes }) {
    ...
    const handleCreate = (e) => {
        e.preventDefault();
        createForm.post('/admin/tax-types', {
            onSuccess: () => {
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        editForm.put(`/admin/tax-types/${selectedTaxType.id}`, {
            onSuccess: () => {
    ...
    const confirmDelete = () => {
        router.delete(`/admin/tax-types/${selectedTaxType.id}`, {
            onSuccess: () => {
